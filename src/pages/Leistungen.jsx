            ...
            {deviceServices.map((service, index) => (
              ...
              >
                <Link 
                  ...
                  className="block h-full bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group"
                >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {damageServices.map((service, index) => (
              ...
              >
                <Link 
                  to={createPageUrl(service.link)}
                  className="block bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group"
                >
